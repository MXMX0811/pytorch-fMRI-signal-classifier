...
train_x, train_y = dataReader([1,3,5,6,7,8,9,10,13,14,15],['mot_1','mot_2','mot_3'])
test_x, test_y = dataReader([18,21,22,23],['mot_1'])
...
LSTM = Rnn(28, 1024,True, 2, 3)  # 28个脑区，序列长度为16，LSTM网络层数2层，3分类
LSTM.to(device)
